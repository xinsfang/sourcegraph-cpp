# C++ code intelligence for Sourcegraph
...
1. Enable the `sourcegraph/cpp` extension:
   - On Sourcegraph.com, visit [sourcegraph.com/extensions/sourcegraph/cpp](https://sourcegraph.com/extensions/sourcegraph/$LANGID) to enable it.
